...
namespace SimplePut2
{
    ...
    class SimplePut
    {
        ...
        private String channelName = "ERPLN3";
        /// <summary>
        ...
        /// Queue name.
        /// </summary>
        private String queueName = "QA.CCP.TO.ERPLN.OrderLine.DEV";
        //private String queueName = "QA.CCP.TO.BIZTALK";
        ...
        static void Main(String[] args)
        {
            ...
            try
            {
                SimplePut simplePut2 = new SimplePut();
                //if (simplePut2.ParseCommandline(args))
                simplePut2.PutMessages();
            }
        ...
        void PutMessages()
        {
            try
            {
                ...
                //String messageString = File.ReadAllText(@"C:\Replica\SharePoint\Solutions - Solution Documents\SE PP Configuration (CCP)\Test\SalesOrder_E63000427.xml");
                String messageString = File.ReadAllText(@"C:\Temp\SEVST-W-CRC6018.txt");
             
                byte[] bytes = Encoding.Default.GetBytes(messageString);                messageString = Encoding.UTF8.GetString(bytes);
